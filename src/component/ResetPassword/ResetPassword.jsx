                ...
                <form onSubmit={formik.handleSubmit} action="#!">
                  <div className="row gy-2 overflow-hidden">
                    <div className="col-12">
                      <label htmlFor="resetCode" className="form-label text-primary mb-1">
                        Reset Code
                      </label>
                      <input
                        ...
                        type="text"
                        className={`form-control bg-gray-50 border border-gray-300 ${formik.touched.resetCode && formik.errors.resetCode ? "is-invalid" : ""
                          }`}
                        name="resetCode"
